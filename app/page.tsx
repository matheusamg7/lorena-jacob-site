  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden min-h-[calc(100vh-70px)] -mt-8">
          ...
          <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 min-h-[calc(100vh-120px)] sm:min-h-[calc(100vh-70px)] flex items-center pt-4 sm:pt-8">
            <div className="max-w-3xl py-4 sm:py-8 md:py-12 pb-20 sm:pb-24 md:pb-32 lg:pl-12 w-full text-center lg:text-left">
              <h1 className="text-[1.75rem] sm:text-[2rem] md:text-[2.75rem] lg:text-[3.5rem] font-bold text-white leading-[1.2] font-[family:var(--font-comfortaa)]">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
              ...
              <div className="text-center mb-6 sm:mb-8">
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#8B7659] font-[family:var(--font-comfortaa)]">
                  Sobre Mim
                </h2>
              </div>
              ...
              <div className="relative">
                ...
                {/* Card marrom */}
                <div className="bg-[#8B7659] rounded-[2rem] sm:rounded-[3rem] overflow-hidden relative z-10">
                  {/* Mobile Layout */}
        ...
        <section className="relative pt-8 sm:pt-12 pb-12 sm:pb-16 mt-6 sm:mt-8 -mb-6 sm:-mb-8 z-10">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
              ...
              <div className="text-center mb-8 sm:mb-12 px-4">
                <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold text-[#8B7659] leading-tight font-[family:var(--font-comfortaa)]">
                  Visite <span className="text-[#8B7659] italic">nosso blog</span>
                </h2>
              </div>
              ...
              <div className="relative">
                ...
                <button className="hidden sm:block absolute -left-4 top-1/2 -translate-y-1/2 bg-white rounded-full p-2 sm:p-3 shadow-lg hover:shadow-xl transition-all cursor-pointer">
                  <svg className="w-5 sm:w-6 h-5 sm:h-6 text-[#8B7659]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="text-center">
                <Link href="/blog">
                  <Button 
                    className="bg-[#8B7659] hover:bg-[#7A654A] text-white font-bold px-8 sm:px-12 md:px-16 py-4 sm:py-5 rounded-full text-base sm:text-lg md:text-xl cursor-pointer"
                  >
                    ACESSE O BLOG
                  </Button>
                </Link>
        ...
        {/* Seção Redes Sociais */}
        <section className="relative py-12 sm:py-16 lg:py-20 bg-white -mt-2 sm:-mt-4">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
              <div className="relative bg-[#8B7659] rounded-[2rem] sm:rounded-[3rem] overflow-hidden h-[450px] sm:h-[500px] lg:h-[600px]">
                ...
                <div className="relative z-10 flex items-center justify-center p-6 sm:p-8 lg:p-12 h-full">
                  ...
                  <div className="lg:hidden text-white text-center">
                    ...
                    <h2 className="text-3xl sm:text-4xl font-bold mb-6 text-[#FFFCB3] -mt-1">
                      REDES SOCIAIS
                    </h2>
                  ...
                  <div className="hidden lg:flex items-center justify-center gap-8 w-full">
                    ...
                    <div className="flex-1 text-white lg:pl-12">
                      ...
                      <h2 className="text-7xl font-bold mb-8 text-[#FFFCB3] -mt-2">
                        REDES SOCIAIS
                      </h2>
        ...
        <section className="py-12 sm:py-16 lg:py-20" style={{ backgroundColor: '#FAFFE7' }}>
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8 sm:mb-12">
              <h2 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold text-[#6FB1CE] font-[family:var(--font-comfortaa)]">
                DEPOIMENTOS
              </h2>
            </div>
            ...
            <div className="relative max-w-6xl mx-auto">
              <div className="flex items-center justify-center gap-2 sm:gap-4">
                {/* Botão Anterior */}
                <button className="bg-[#6FB1CE] rounded-full p-2 sm:p-3 hover:bg-[#5fa0bf] transition-colors">
