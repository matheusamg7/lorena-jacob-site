      ...
      <main className="flex-1">
        ...
        <section className="relative pt-20 pb-8 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
            {/* Blog Title */}
            <h1 className="text-7xl lg:text-8xl font-bold text-[#8B7659] text-center mb-12 font-[family:var(--font-playfair)]">
              Blog
            </h1>
            ...
            {/* Post Count */}
            <p className="text-center text-[#8B7659]/70 mb-4">
        ...
        {/* Blog Posts Grid */}
        <section className="pt-4 pb-8 bg-[#FAFFE7]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
            ...
            {filteredPosts.length > 0 && (
              <div className="text-center mt-12">
                <button className="bg-[#6FB1CE] hover:bg-[#5fa0bf] text-white font-bold px-8 py-3 rounded-full transition-colors cursor-pointer">
                  Carregar Mais Posts
                </button>
              </div>
            )}
